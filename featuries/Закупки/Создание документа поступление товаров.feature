...
Как менеждер по закупкам я хочу
...
*Заполнение товарной части
	...
	И в таблице 'Товарs' я завершаю редактирование строки
*Проверка заполнения ТЧ
	Тогда таблица "Товары" содержит строки: 
		| "Товар" | "Цена"   |"Артикул"| "Количество" | "Сумма"    |
		| "Торf " | "150,00" |"178"| '15,00'      | "1 500,00" |
...
сценарий: проверка  наличие в справочнике номенклатуры Торт
